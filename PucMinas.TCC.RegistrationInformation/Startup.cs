...
using PucMinas.TCC.RegistrationInformation.HostedServices;
using PucMinas.TCC.RegistrationInformation.Persistences.SqlServer;
using System;
using System.Text;

namespace PucMinas.TCC.RegistrationInformation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IChargeHistoryRepository, ChargeHistoryRepository>();
            services.AddTransient<IStepRepository, StepRepository>();

            services.AddHostedService<IntegrationLegacyHostedService>();

            services.AddDistributedRedisCache(options =>
            {
                options.Configuration = Configuration.GetConnectionString("RedisConnection");
                options.InstanceName = "RegistrationInformation:";
            });
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Registration Information Service - Puc Minas TCC",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (!env.IsProduction() && !env.IsStaging())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("./swagger/v1/swagger.json", "Registration Information Service - V1");
